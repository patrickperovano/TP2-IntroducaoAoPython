# Exercício 11
"""
Dado o texto na variável mensagem, faça um programa que conta a porcentagem de vogais em relação a todos os caracteres da string (espaços e pontuações devem ser contabilizado na porcentagem). Seu programa deve ter comentários"""
